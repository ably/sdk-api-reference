...
| channelRetryTimeout: Duration default 15s || RTL13b, TO3l7 | TBD |
...
| maxMessageSize: Int default 65536 || TO3l8 | TBD |
| maxFrameSize: Int default 524288 || TO3l8 | TBD |
| plugins: `Dict<PluginType, Plugin>` || TO3o | TBD |
...
| agents: [String: String?]? || RSC7d6 - interface only offered by some libraries | TBD |
